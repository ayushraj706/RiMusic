...
export default function LoginComponent() {
  ...
  const handleAgentLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        localStorage.setItem("agent_primary_page", data.agent.primaryPage || "/chat");
  ...
  return (
    ...
    >
      ...
      <motion.h1 
        className="text-3xl font-light tracking-tight text-gray-950 mb-1"
      ...
      >
        ...
        {/* ADMIN MODE: SOCIAL BUTTONS (Google, Facebook, GitHub, X) */}
        {loginMode === "ADMIN" ? (
          <>
            <motion.button 
          ...
          /* AGENT MODE: EMAIL & PASSWORD FORM */
          <form onSubmit={handleAgentLogin} className="space-y-3 text-left">
            <div>
              <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-xl border border-gray-200 focus-within:border-[#00A884]">
            ...
            <motion.button 
              ...
              whileHover={{ scale: 1.02 }} 
              whileTap={{ scale: 0.98 }} 
              className="w-full bg-[#00A884] text-white py-3.5 rounded-xl font-bold hover:bg-[#009172] transition-colors shadow-sm flex items-center justify-center gap-2 mt-2 disabled:opacity-70"
            >
