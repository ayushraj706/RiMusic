...
import Sidebar from "../components/chat/Sidebar"; // Adjusted path
import ChatBubble from "../components/chat/ChatBubble"; // Adjusted path
import ChatInput from "../components/chat/ChatInput"; // Adjusted path
import ThemeSelector, { ChatTheme } from "../components/chat/ThemeSelector"; // Adjusted path
...
import {
  ...
  sendLocationMessage,
  sendTemplateMessage,
} from "../lib/chatLogic"; // Adjusted path
